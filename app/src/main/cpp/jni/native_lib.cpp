...
Java_com_orbit_music_native_NativeDSP_nativeCreateEngine(JNIEnv* /*env*/, jobject /*thiz*/) {
    auto* chain = new DSPChain();
    return reinterpret_cast<jlong>(chain);
}

JNIEXPORT void JNICALL
Java_com_orbit_music_native_NativeDSP_nativeDestroyEngine(JNIEnv* /*env*/, jobject /*thiz*/, jlong handle) {
    if (handle != 0) {
...
JNIEXPORT void JNICALL
Java_com_orbit_music_native_NativeDSP_nativeSetSampleRate(JNIEnv* /*env*/, jobject /*thiz*/, jlong handle, jfloat sampleRate) {
    if (handle != 0) {
...
JNIEXPORT void JNICALL
Java_com_orbit_music_native_NativeDSP_nativeSetEnabled(JNIEnv* /*env*/, jobject /*thiz*/, jlong handle, jboolean enabled) {
    if (handle != 0) {
...
JNIEXPORT void JNICALL
Java_com_orbit_music_native_NativeDSP_nativeSetEngineMode(JNIEnv* /*env*/, jobject /*thiz*/, jlong handle, jint mode) {
    if (handle != 0) {
...
JNIEXPORT void JNICALL
Java_com_orbit_music_native_NativeDSP_nativeSetGraphicMode(JNIEnv* /*env*/, jobject /*thiz*/, jlong handle, jint numBands) {
    if (handle != 0) {
...
JNIEXPORT void JNICALL
Java_com_orbit_music_native_NativeDSP_nativeSetGraphicBandGain(JNIEnv* /*env*/, jobject /*thiz*/, jlong handle, jint bandIndex, jfloat gainDb) {
    if (handle != 0) {
...
Java_com_orbit_music_native_NativeDSP_nativeGetGraphicFrequencies(JNIEnv* env, jobject /*thiz*/, jlong handle) {
...
JNIEXPORT void JNICALL
Java_com_orbit_music_native_NativeDSP_nativeSetParametricBand(
...
JNIEXPORT void JNICALL
Java_com_orbit_music_native_NativeDSP_nativeSetPreampGain(JNIEnv* /*env*/, jobject /*thiz*/, jlong handle, jfloat gainDb) {
    if (handle != 0) {
...
JNIEXPORT void JNICALL
Java_com_orbit_music_native_NativeDSP_nativeSetBassBoost(
...
JNIEXPORT void JNICALL
Java_com_orbit_music_native_NativeDSP_nativeSetTrebleBoost(
    JNIEnv* /*env*/, jobject /*thiz*/, jlong handle, jboolean enabled, jfloat strength) {
    if (handle != 0) {
        auto* chain = reinterpret_cast<DSPChain*>(handle);
...
JNIEXPORT void JNICALL
Java_com_orbit_music_native_NativeDSP_nativeSetCompressor(
    JNIEnv* /*env*/, jobject /*thiz*/, jlong handle,
...
Java_com_orbit_music_native_NativeDSP_nativeIsClipping(JNIEnv* /*env*/, jobject /*thiz*/, jlong handle) {
    if (handle != 0) {
...
JNIEXPORT void JNICALL
Java_com_orbit_music_native_NativeDSP_nativeSetLimiter(JNIEnv* /*env*/, jobject /*thiz*/, jlong handle, jboolean enabled, jfloat thresholdDb) {
    if (handle != 0) {
        auto* chain = reinterpret_cast<DSPChain*>(handle);
...
JNIEXPORT void JNICALL
Java_com_orbit_music_native_NativeDSP_nativeProcessBuffer(JNIEnv* env, jobject /*thiz*/, jlong handle, jfloatArray buffer, jint numFrames) {
...
JNIEXPORT void JNICALL
Java_com_orbit_music_native_NativeDSP_nativeGetCurve(
...
JNIEXPORT void JNICALL
Java_com_orbit_music_native_NativeDSP_nativeGetSpectrum(JNIEnv* env, jobject /*thiz*/, jlong handle, jfloatArray outBands) {
...
JNIEXPORT jfloatArray JNICALL
Java_com_orbit_music_native_NativeDSP_nativeGetPeakLevels(JNIEnv* env, jobject /*thiz*/, jlong handle) {
    if (handle == 0) return nullptr;
