package com.orbit.music.data.cover
...
object MusicBrainzCoverService {
    ...
    private const val USER_AGENT = "OrBitPlayer/0.1.7 ( contact@orbitplayer.dev )"
    ...
    suspend fun checkAndFetchLargeCover(
        ...
        if (!force) {
            val prefs = context.getSharedPreferences("com.orbit.music_preferences", Context.MODE_PRIVATE)
